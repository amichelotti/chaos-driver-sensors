 ...
 */
#ifndef VLUCIDOUTPUT_h
#define VLUCIDOUTPUT_h
...
DEFINE_CU_DRIVER_DEFINITION_PROTOTYPE(LucidOutputDriver)
...
/*
 driver definition
 */
class LucidOutputDriver:public ::driver::sensor::AbstractSensorDriver{
