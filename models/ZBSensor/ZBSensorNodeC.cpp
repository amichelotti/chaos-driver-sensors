...
OPEN_CU_DRIVER_PLUGIN_CLASS_DEFINITION(ZBSensorNodeC, 1.0.0,::driver::sensor::model::ZBSensorNodeC)
REGISTER_CU_DRIVER_PLUGIN_CLASS_INIT_ATTRIBUTE(::driver::sensor::model::ZBSensorNodeC, http_address/dnsname:port)
