 ...
 */
#ifndef ChaosRTControlUnit_SCCameraFilter_h
#define ChaosRTControlUnit_SCCameraFilter_h
...
class SCCameraFilter : public chaos::cu::control_manager::RTAbstractControlUnit {
	PUBLISHABLE_CONTROL_UNIT_INTERFACE(SCCameraFilter);
...
public:
     ...
     */
    SCCameraFilter(const std::string& _control_unit_id, const std::string& _control_unit_param, const ControlUnitDriverList& _control_unit_drivers);
    /*!
     Destructor a new CU
     */
    ~SCCameraFilter();
